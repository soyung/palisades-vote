...
const DISTRICTS = {
  rda: {
    ...
    death: <>Governor Jerry Brown abolished all ~400 RDAs in 2012 to close a $1B+ state budget gap. Because the state was backfilling the school tax shortfall, every dollar of increment captured cost the state general fund. The California Supreme Court upheld the abolition in <a href="https://law.justia.com/cases/california/supreme-court/2011/s194093.html" target="_blank" rel="noopener noreferrer" style={{color:"inherit",textDecoration:"underline",textDecorationColor:"#92400e",textUnderlineOffset:2}}>California Redevelopment Assn. v. Matosantos (2011)</a>. ~$5B/yr in redevelopment spending vanished overnight.</>,
    examples: [
