...
const DISTRICTS = {
  rda: {
    ...
    law: "Community Redevelopment Law (Health & Safety Code §33000)",
    ...
    death: "Governor Jerry Brown abolished all ~400 RDAs in 2012 to close a $1B+ state budget gap. Because the state was backfilling the school tax shortfall, every dollar of increment captured cost the state general fund. The California Supreme Court upheld the abolition in California Redevelopment Assn. v. Matosantos (2011). ~$5B/yr in redevelopment spending vanished overnight.",
    examples: [
  ...
  ifd: {
    ...
    law: "Gov. Code §53395 et seq. (enacted 1990)",
    year: 1990,
  ...
  eifd: {
    ...
    law: "SB 628 (2014), Gov. Code §53398.50 et seq.",
    year: 2014,
    ...
    examples: [
      { name: "West Sacramento EIFD No. 1", year: 2015, reason: "Mixed-use waterfront infrastructure (Bridge District)", notes: "One of the first EIFDs formed after SB 628" },
  ...
  crd: {
    ...
    law: "SB 852 (2022), Gov. Code §62300 et seq.",
    year: 2022,
  ...
  drd: {
    ...
    law: "SB 782 (2025, urgency statute), amending Gov. Code §62300",
    year: 2025,
          ...
          <section ref={setRef("crd-drd")} data-section="crd-drd" style={{ marginBottom: 70 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, marginBottom: 4 }}>
              <div style={{ background: `${C.crd}0e`, border: `2px solid ${C.crd}30`, borderRadius: 10, padding: "16px 20px" }}>
                ...
                <div style={{ fontSize: 12, color: T.sub }}>Climate Resilience District · SB 852 (2022)</div>
              ...
              <div style={{ background: `${C.drd}0e`, border: `2px solid ${C.drd}30`, borderRadius: 10, padding: "16px 20px" }}>
                ...
                <div style={{ fontSize: 12, color: T.sub }}>Disaster Recovery District · SB 782 (2025)</div>
                <div style={{ marginTop: 10, fontSize: 12.5, color: T.body, lineHeight: 1.6 }}>
